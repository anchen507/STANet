...
def low_net(input_image):
    ...
    #print(w)
    #resized_input = tf.image.resize_images(input_L, [h/2, w/2], method=tf.image.ResizeMethod.BICUBIC)#下采样，三次插值
    #resized_input = tf.image.resize_images(input_L, [h/2, w/2], method=tf.image.ResizeMethod.BILINEAR)#下采样，三次插值
